...
/*package*/ final class MaprefIncluder extends Includer implements Constants {
    ...
    public MaprefIncluder(KeySpaces keySpaces, String[] documentLoaderOptions,
                          ConsoleHelper console) {
        super(keySpaces, documentLoaderOptions, console);
    }
    ...
    protected Incl detectInclusion(Element element) {
        ...
        String format = DITAUtil.getFormat(element, href, scope);
        if (format == null) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LoadedDocument loadedDoc = 
          (new LoadedDocuments(null, null, null)).load(inFile.toURI().toURL());

        ConsoleHelper console = new ConsoleHelper(
            new SimpleConsole(null, false, SimpleConsole.MessageType.ERROR));
        MaprefIncluder includer = new MaprefIncluder(null, null, console);
