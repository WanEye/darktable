...
/*package*/ final class Chunker implements Constants {
    public final boolean defaultPolicyIsByTopic;
    public final String defaultRootName;
    ...
    public Chunker(boolean byTopic, String rootName, ConsoleHelper console) {
    ...
    private static String getNavtitle(Element topicref) {
        ...
        if (topicmeta != null) {
            ...
            if (navtitle != null) {
                title = DITAUtil.getTextContent(navtitle);
                if (title != null &&
