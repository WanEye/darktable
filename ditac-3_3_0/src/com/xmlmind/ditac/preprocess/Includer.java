...
/*package*/ abstract class Includer {
    ...
    protected Includer(KeySpaces keySpaces, String[] documentLoaderOptions,
    ...
    public boolean process(LoadedDocument[] loadedDocs) 
        throws IOException {
        docs = new Docs(keySpaces, documentLoaderOptions, console);
        docList = new ArrayList<Doc>();
        processedDocCount = 0;

        for (LoadedDocument loadedDoc : loadedDocs) {
    ...
    protected static final class Docs extends LoadedDocuments {
        public Docs(KeySpaces keySpaces, String[] documentLoaderOptions,
                    ConsoleHelper console) {
