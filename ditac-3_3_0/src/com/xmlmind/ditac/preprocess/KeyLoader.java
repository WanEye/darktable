...
/*package*/ final class KeyLoader implements Constants {
    ...
    public KeyLoader(String[] documentLoaderOptions, ConsoleHelper console) {
    ...
    public boolean prepareMap(Document doc, URL url) 
        ...
        return (new MapSimplifier(/*keySpaces*/ null, documentLoaderOptions,
    ...
    public KeySpaces createKeySpaces(LoadedDocuments loadedTopics) {
        if (loadedTopics == null) {
            loadedTopics = new LoadedDocuments(/*keySpaces*/ null, 
    ...
    private boolean addKeys(String keyList, Element element, 
        ...
        if (href != null) {
            ...
            if (url != null) {
                ...
                format = DITAUtil.getFormat(format, href, scope);

                if ("local".equals(scope) && "dita".equals(format)) {
                    // We have a local topic whose URL has no #topic_id
                    // fragment.
                    ...
                    if (firstTopic != null) {
                        href =
                            URIComponent.setFragment(href, firstTopic.topicId);
