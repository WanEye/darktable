...
public class Converter {
    ...
    private boolean parseOptions(String[] args) {
        ...
        ArrayList<String> docLoaderOpts = new ArrayList<String>();
        ...
        for (l = 0; l < args.length; ++l) {
            ...
            if ("-p".equals(arg) || "-param".equals(arg)) {
                ...
                if (name.startsWith("load.")) {
                    // Document loader option. Keep "load." prefix.

                    docLoaderOpts.add(name);
                    docLoaderOpts.add(value);
                } else {
                    params.add(name);
                    params.add(value);
        ...
        preProc.setDocumentLoaderOptions(
            docLoaderOpts.toArray(StringUtil.EMPTY_LIST));
